...
An auth0 training lab tracing an OIDC authentication request using auth code flow with PKCE.
...
1. Clone this repository to your local machine.
  ```bash
  git clone https://github.com/auth0-training/labs-node-oidc-auth-code-with-pkce-trace.git
  ```
